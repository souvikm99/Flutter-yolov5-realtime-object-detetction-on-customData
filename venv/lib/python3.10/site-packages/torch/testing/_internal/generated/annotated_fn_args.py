...
annotated_args = {
    ...
    torch._C._VariableFunctions._native_multi_head_self_attention: [{'name': 'query', 'simple_type': 'Tensor'}, {'name': 'qkv_weight', 'simple_type': 'Tensor'}, {'name': 'qkv_bias', 'simple_type': 'Tensor'}, {'name': 'proj_weight', 'simple_type': 'Tensor'}, {'name': 'proj_bias', 'simple_type': 'Tensor'}],
    ...
    torch._C._VariableFunctions.scatter_reduce: [{'name': 'self', 'simple_type': 'Tensor'}, {'name': 'dim', 'simple_type': 'int64_t'}, {'name': 'index', 'simple_type': 'Tensor'}, {'name': 'reduce', 'simple_type': 'c10::string_view'}],
    ...
    torch.Tensor.scatter_reduce: [{'name': 'self', 'simple_type': 'Tensor'}, {'name': 'dim', 'simple_type': 'int64_t'}, {'name': 'index', 'simple_type': 'Tensor'}, {'name': 'reduce', 'simple_type': 'c10::string_view'}],
